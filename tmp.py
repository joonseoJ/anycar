...
def load_jax_model():
    ...
    model = JaxDynamicsPredictor(
        ...
        output_dim=model_config.STATE_DIM
    )
    ...
    dummy_hist = jnp.ones((BATCH, T, model_config.NUM_ENTITIES, model_config.HISTORY_DIM))
    dummy_static = jnp.ones((BATCH, model_config.NUM_ENTITIES, model_config.STATIC_DIM))
